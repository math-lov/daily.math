...
window.BANK = {
 ...
 "questions": [
  ...
  },
  {
   ...
   "timeSec": 90,
   "stem": {
    "text": "Let f(x)=x^{2}+7x+k, where k is a constant. If f(4)+f(-4)=38, find k.",
    "html": "Let f(x)=$x^{2}$+7x+k, where k is a constant. If f(4)+f(-4)=38, find k.",
  ...
  },
  {
   ...
   "timeSec": 90,
   "stem": {
    "text": "The height and the total surface area of a solid right circular cylinder are 35 cm and 492\\pi\\text{ cm}^{2} respectively. If the radius of a solid sphere is equal to the base radius of the circular cylinder, then the volume of the sphere is",
    "html": "The height and the total surface area of a solid right circular cylinder are 35 cm and 492$\\pi$$\\text{ cm}$^{2} respectively. If the radius of a solid sphere is equal to the base radius of the circular cylinder, then the volume of the sphere is",
    "latex": null
   },
   "figure": null,
   "notes": null,
  ...
  },
  {
   ...
   "stem": {
    ...
    "html": "In the figure, ABCD is a square. Let E be a point such that CDEF is a rhombus, where F is a point lying on AC produced. DF is produced to the point G such that AF // BG. Which of the following are true?<br>I. DF = FG<br>II. $\\Delta$ BFG $\\sim$ $\\Delta$ DEF<br>III. $\\angle$ ABG + $\\angle$ BFD = 18$0^{\\circ}$",
    "latex": null
   },
  ...
  },
  {
   ...
   "stem": {
    ...
    "html": "It is given that PQRS is a trapezium with PQ // SR. If PS=41$\\text{ cm}$, RS=53$\\text{ cm}$, $\\angle$ PSR=12$0^{\\circ}$ and $\\angle$ QRS=15$0^{\\circ}$, then PQ=",
  ...
  },
  {
   ...
   "stem": {
    ...
    "html": "In the figure, ABCD is a rectangle. It is given that AE=20$\\text{ cm}$ and $\\angle$ AED=9$0^{\\circ}$. If the area of $\\Delta$ ADE is 150$\\text{ cm}$^{2}, then the perpendicular distance from E to CD is",
  ...
  },
  {
   ...
   "timeSec": 120,
   "stem": {
    "text": "In the figure, RSTUV is a circle. It is given that RT // VU and RT is the angle bisector of \\angle SRU. If \\angle RTS=\\angle URV=33^{\\circ}, then \\angle RUT=",
    "html": "In the figure, RSTUV is a circle. It is given that RT // VU and RT is the angle bisector of $\\angle$ SRU. If $\\angle$ RTS=$\\angle$ URV=3$3^{\\circ}$, then $\\angle$ RUT=",
  ...
  },
  {
   ...
   "timeSec": 90,
   "stem": {
    "text": "The figure shows the quadrilateral ABCD. If \\angle ABC+\\angle ADC=\\angle ACD=\\angle BAC=90^{\\circ}, which of the following must be true?",
    "html": "The figure shows the quadrilateral ABCD. If $\\angle$ ABC+$\\angle$ ADC=$\\angle$ ACD=$\\angle$ BAC=9$0^{\\circ}$, which of the following must be true?",
  ...
  },
  {
   ...
   "stem": {
    ...
    "html": "The polar coordinates of the points X, Y and Z are (1, 2$0^{\\circ}$), (2, 8$0^{\\circ}$) and (r, $\\theta$) respectively, where 2$0^{\\circ}$ &lt; $\\theta$ &lt; 8$0^{\\circ}$. If $\\Delta$ XYZ is an equilateral triangle, find r.",
  ...
  },
  {
   ...
   "timeSec": 120,
   "stem": {
    "text": "The bar chart below shows the distribution of the numbers of books read by some teachers in a certain month. Find the inter-quartile range of the distribution.",
    "html": "The bar chart below shows the distribution of the numbers of books read by some teachers in a certain month. Find the inter-quartile range of the distribution.",
    "latex": null
   },
  ...
  },
  {
   ...
   "timeSec": 120,
   "stem": {
    "text": "The L.C.M. of p^{2}-4q^{2}, p^{3}-8q^{3} and (p+2q)(p^{2}-4q^{2}) is",
    "html": "The L.C.M. of $p^{2}$-4$q^{2}$, $p^{3}$-8$q^{3}$ and (p+2q)($p^{2}$-4$q^{2}$) is",
  ...
  },
  {
   ...
   "timeSec": 120,
   "stem": {
    "text": "It is given that \\log_{5}y is a linear function of \\log_{25}x. The intercepts on the vertical axis and on the horizontal axis of the graph of the linear function are 12 and 2 respectively. If y=mx^{n}, then n=",
    "html": "It is given that $\\log_{5}$y is a linear function of $\\log_{25}$x. The intercepts on the vertical axis and on the horizontal axis of the graph of the linear function are 12 and 2 respectively. If y=m$x^{n}$, then n=",
    "latex": "y=mx^{n}"
   },
   "figure": null,
   "notes": null,
  ...
  },
  {
   ...
   "stem": {
    ...
    "html": "On the same rectangular coordinate system, the graph of y=$\\log_{a}$x cuts the graph of y=$a^{x}$ and the x-axis at the points P and Q respectively, where a is a positive constant. Denote the origin by O. Which of the following are true?<br>I. a &lt; 1<br>II. OQ &gt; a<br>III. $\\angle$ POQ = 4$5^{\\circ}$",
  ...
  },
  {
   ...
   "stem": {
    ...
    "html": "In the figure, AC is a diameter of the circle ABCD. Denote the point of intersection of AC and BD by E. It is given that TD is the tangent to the circle at D. If $\\angle$ BEC=9$6^{\\circ}$ and $\\angle$ CDT=4$1^{\\circ}$, then $\\angle$ CDE=",
  ...
  },
  {
   ...
   "stem": {
    ...
    "html": "For 9$0^{\\circ}$ &lt; $\\theta$ &lt; 27$0^{\\circ}$, how many roots does the equation $\\tan^{3}$$\\theta$=2$\\tan$$\\theta$ have?",
