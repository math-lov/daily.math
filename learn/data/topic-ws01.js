 ...
 "lessons": [
  {
   ...
   "cards": [
    ...
    },
    {
     ...
     "body": {
      "zh": "用來分解 $ax^{2}+bx+c$ 這類二次三項式。把首項與末項各自拆成兩個因數，交叉相乘（cross-method）後相加，要等於中間項。\n例：$6x^{2}-13x-5$。首項 $6x^{2}=2x\\cdot 3x$，末項 $-5=(-5)\\times(+1)$，交叉相乘：$2x\\times 1$ 加 $3x\\times(-5)$ 得 $-13x$，符合中間項，所以答案是 $(2x-5)(3x+1)$。\n做完一定要檢查中間項，錯符號是最常見的失分位。"
     },
     "math": [
     ...
     "warn": {
      "zh": "末項是負數時，兩個因數一正一負；末項是正數、中間項又是正數時，兩個因數都是正。用這個規則可以快速排除錯的組合。"
     }
    },
    {
     "id": "ws01-c6",
